# Github repository: https://github.com/sangeetaPalankar/pyhon-alarmclock.git


#Alarm Clock for playing random Youtube video
...
#select random link from a text file
def randomVideo():
